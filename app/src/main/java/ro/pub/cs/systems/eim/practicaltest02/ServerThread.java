...
public class ServerThread extends Thread {
    ...
    private HashMap<String, Long> timestamps = null;
    ...
    public synchronized void setTimestamps(String key, long timestamp) {
    ...
    public synchronized HashMap<String, Long> getTimetamps() {return timestamps;}
